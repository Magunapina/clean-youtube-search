...
Shortcuts work while no input field is focused.\
Pressing `Enter` while typing in a text field only unfocuses the field; pressing `Enter` again with nothing focused runs the search.

| Key                   | Action                                           |
| --------------------- | ------------------------------------------------ |
| `Enter`               | Run the search                                   |
| `/`                   | Focus the Search Keyword field                   |
| `i`                   | Focus the Channel ID field                       |
| `←` / `→`             | Go to the previous / next page                   |
| `r` / `d`             | Set Order to Relevance / Date                    |
| `n` / `l` / `a` / `u` | Set Broadcast to Any / Live / Archive / Upcoming |
