...
<div
  class="sticky bottom-0 z-30 mt-auto flex items-center justify-center gap-4 bg-neutral-800 px-6 py-2"
>
  <button
    class="flex items-center justify-center rounded-full bg-neutral-700 px-10 py-2.5 text-neutral-100 transition-colors hover:bg-neutral-600 hover:text-white disabled:cursor-not-allowed disabled:opacity-30"
